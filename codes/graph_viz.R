...
for (file in files){
  ...
  processed_graph <- network_graph %>% filter(Weight > 0.95)
  ...
  plot_name = paste("D:/scRNA-Seq_data/final_schwartz_networks/", file_sub, "_095.png", sep = "")
  png(plot_name, width = 4800, height = 3200)
  # Creates the plot
  plot(igraph_obj, edge.arrow.size=.5, vertex.color="gold", vertex.size=1,
